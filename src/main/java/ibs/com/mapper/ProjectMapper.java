...
public interface ProjectMapper {
	...
	public List<ProjectVO> allProject(String team, String title);
    ...
    //슬희====================================================================
	public List<ProjectVO> selectTeam(int parseInt);
	public List<ProjectVO> selectTitle(String project_title);
	public List<ProjectVO> selectTeamAndTitle(ProjectVO vo);
